		...
		<div class='container'>
			<div class="wrapper">
				...
				<div class="login">
					...
					<a scope="public_profile,email" onlogin="checkLoginState();" href="#"><div class="facebook"></div></a>
					<div class="or"></div>
					<form method="post" action="login_process.do">
						<div class="input">
							<input type="text" name="j_username" placeholder="ID" class="box" autofocus>
							<div class="logo"></div>
						</div>
						<div class="input">
							<input type="password" name="j_password" placeholder="PW" class="box" autofocus>
							<div class="logo"></div>
						</div>
